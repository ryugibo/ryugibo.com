...
export default [
  layout("common/layouts/home-layout.tsx", [
    ...
    ...prefix("/community", [
      ...
      route("/:id", "features/community/pages/post-page.tsx"),
      route("/:id/upvote", "features/community/pages/post-upvote-page.tsx"),
    ...
    ...prefix("/my", [
      ...
      route("/notifications/:id", "features/users/pages/notification-page.tsx"),
